...
export const Eyes = () => {
  ...
  return (
    <div  className="w-full eyes h-screen overflow-hidden">
      <div data-scroll data-scroll-speed='-.7' className='bg-cover h-full w-full bg-center relative bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg")]'>
        <div className="absolute flex items-center justify-center gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]">
          ...
          >
            <div 
            className="w-[13rem] relative h-[13rem] bg-zinc-900 rounded-full">
              <div
                style={{
